...
#figure(
  ...
  caption: [A fractal tree with a depth of 10, that varies the angle under which ],
) <fig-fractal-tree>
...
The library was published on PyPi #footnote[https://pypi.org/project/mglyph/] under the name `mglyph`. It is essentially a framework to facilitate the work of designing, producing, and distributing malleable glyphs written in the Python programming language. The reason why Python was used is that it is a widely-adopted popular language, and many developers already know how to work with it. Its syntax offers much flexibility that was needed for such a library.
